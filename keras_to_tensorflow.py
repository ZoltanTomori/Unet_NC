...
# SPUSTIT V ANACONDA PROMT
# python keras_to_tensorflow.py --input_model="C:\Users\Lucia\source\repos\Unet_NC\Unet_NC\model\ourModel.h5" --output_model="C:\Users\Lucia\source\repos\Unet_NC\Unet_NC\model\ourModel.pb"
...
def main(args):
    ...
    if FLAGS.quantize:
        from tf.tools.graph_transforms import TransformGraph
